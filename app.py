...
# Define years 2000 to 2020
years = [str(year) for year in range(2000, 2021)]

# Filter DataFrame for indicators 9 and 10
...
with tabs[0]:
    ...
    # Limit the dropdown options to indicators 9 and 10
    ...
    # Generate Altair chart based on the selected indicator
...
with tabs[1]:
    ...
    # Melt the dataframe for the second line chart
    ...
    # filtered dataframe for drinking water chart
    ...
    # Display the stacked bar chart and line chart
...
with tabs[2]:
    ...
    #the result of these situations

    filtered_df_5 = df[df['Indicator Name'].isin(['Net migration'])]

    # Melt the dataframe for the line chart
